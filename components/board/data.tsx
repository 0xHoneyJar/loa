        ...
        <div className="flex h-1/3 grow flex-col p-4 md:p-6">
          ...
          <div className="relative flex size-full flex-col items-center justify-between">
            ...
            <a
              ...
              target="_blank"
              className="flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-full bg-[#F4C10B] py-3 font-medium text-black transition-all duration-500 ease-in-out hover:shadow-yellow"
            >
