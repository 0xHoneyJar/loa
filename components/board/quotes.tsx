...
const Quotes = ({ quoteNumber }: { quoteNumber: number }) => {
  ...
  return (
    ...
    >
      <div className="h-2 w-full rounded-t-3xl bg-white flex shrink-0" />
      <div className="relative flex h-16 items-center justify-between border-b border-dashed border-[#FFFFFF1F] px-6 shrink-0">
        <div
