...
const Explore = () => {
  return (
    <NavigationMenuItem className="" value="explore">
      <NavigationMenuTrigger className="flex h-[36px] items-center rounded-full border border-[#F4C10B24] bg-gradient-to-b from-[#F4C10B1F] to-[#F8A9291F] px-4 text-xs font-medium text-white hover:border-[#F4C10B58] hover:from-[#F4C10B32] hover:to-[#F8A92932] md:text-sm">
        <p>Explore</p>
