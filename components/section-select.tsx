...
const SectionSelect = () => {
  return (
    ...
    <NavigationMenuItem value="section">
      <NavigationMenuTrigger className="flex cursor-blue items-center gap-1 rounded-full bg-[#FFFFFF0F] px-6 py-2.5 text-xs text-white hover:bg-white/30 lg:text-sm">
        Section
      </NavigationMenuTrigger>
