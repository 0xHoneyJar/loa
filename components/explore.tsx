...
const Explore = () => {
  return (
    <NavigationMenuItem className="">
      <NavigationMenuTrigger className="flex h-[38px] items-center rounded-full border border-[#F4C10B24] bg-gradient-to-b from-[#F4C10B1F] to-[#F8A9291F] px-6 text-white hover:border-[#F4C10B58] hover:from-[#F4C10B32] hover:to-[#F8A92932]">
        <p>Explore</p>
