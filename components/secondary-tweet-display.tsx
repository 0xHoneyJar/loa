...
const SecondaryTweetDisplay = ({ text }: { text: string }) => {
  return (
    <div
      className={`absolute -top-6 flex h-full w-full scale-90 flex-col divide-y divide-[#292929]/30 rounded-lg bg-[#1E1E1E]/30`}
    >
      ...
      <div className="flex h-full w-full overflow-hidden p-4 md:p-6">
        <p className="overflow-y-auto overflow-x-hidden text-xs font-light md:text-base text-white/30">
          {text}
        </p>
      </div>
    </div>
