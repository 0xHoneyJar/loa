...
- [ ] **Task 1.A (NEW v1.1 per Flatline BLOCKER SKP-005)**: Adversarial secret-redaction test fixtures — exercise NFR-Sec2/Sec10 redaction layers against transformed token leakage paths that a naive regex misses:
...
- [ ] **Task 2.E2E**: End-to-End Goal Validation — all four PRD goals validated with documented evidence
