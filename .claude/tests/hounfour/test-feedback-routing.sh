...
# Test 5: AWS key redaction
echo ""
echo "Test 5: AWS key redacted"
...
# Test 6: Absolute path redaction
echo ""
echo "Test 6: Absolute path redacted"
...
# Test 7: GitHub token redaction
echo ""
echo "Test 7: GitHub token redacted"
...
# Test 8: Clean input passes through unchanged
echo ""
echo "Test 8: Clean input passes through"
...
# Test 9: Exit code 1 for missing --input
echo ""
echo "Test 9: Missing --input"
EXIT_CODE=0
bash "$SCRIPTS_DIR/feedback-redaction.sh" >/dev/null 2>&1 || EXIT_CODE=$?
assert_eq "missing --input returns exit 1" "1" "$EXIT_CODE"

# Test 10: Preview mode writes to stderr
echo ""
echo "Test 10: Preview mode"
...
# Test 11: Construct path in context → classification: construct
echo ""
echo "Test 11: Construct path classification"
pushd "$MOCK_DIR" > /dev/null
...
# Test 12: No construct path → existing classification (backward compat)
echo ""
