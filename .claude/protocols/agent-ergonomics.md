...
This bounds unbudgeted adversarial fan-outs that balloon past any single
skill's cost profile.
...
Introduced in cycle-119; the fan-out budget rule follows the E10 892K-token fan-out incident.
