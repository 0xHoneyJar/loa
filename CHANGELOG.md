...
## [1.48.0] — 2026-02-18 — Hounfour Runtime Bridge — Model-Heterogeneous Agent Routing


Hounfour Runtime Bridge — Model-Heterogeneous Agent Routing for the Loa framework. Adds Google Gemini adapter support (standard + Deep Research), metering/billing pipeline, Flatline multi-model routing, Hounfour v7 protocol alignment, and epistemic trust scopes with context filtering.
